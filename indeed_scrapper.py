...
filename = "indeed-datascientist-" + extn + ".txt"
filehandle = io.open(filename,"w", encoding="utf-8")

#pages = [10, 20, 30, 40, 50]
for page in range(10):
    if page == 0:
        source = requests.get('https://www.indeed.co.in/data-scientist-jobs').text
    else:
        source = requests.get('https://www.indeed.co.in/jobs?q=data+scientist&start={}'.format(page*10)).text
